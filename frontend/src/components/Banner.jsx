    ...
    <div className={container}>
      <div className={glassBox}>
        <div className={geometricOverlay}>
          <div className=" absolute -top-10 -right-10 md:-top-20 md:-right-20 w-48 h-48 md:w-96 md:h-96 bg-[#F8FFAE]/10 rounded-full blur-xl md:blur-3x1" />
          <div className=" absolute -bottom-20 -left-20 md:-bottom-40 md-left-40 h-40 w-40 md:w-80 md:h-80 bg-[#43C6AC]/10 rounded-full blur-xl md:blur-3x1" />
        </div>
          ...
          <div className=" space-y-6 md:space-y-8">
            <div className=" space-y-4 md:space-y-6">
              ...
              <p className={paragraphText}>
                Curated knowledge journeys that challenge perceptons and inspire
            ...
            <form onSubmit={handleSearch} className=" space-y-6 md:space-y-8">
              <div className={formContainer}>
                <div className={inputWrapper}>
                  <div className=" absolute inset-0 bg-white/90 rounded-lg md:rounded-x1 shadow-sm" />
                  <div className=" relative flex items-center">
                    <Search className=" ml-4 md:ml-5 w-5 h-5 md:w-6 md:h-6 text-grey-600 group-focus-within:text-[#2B5876]" />
                    <input
                      type="text"
                      value={searchQuery}
        ...
        <div className={scrollTextSection}>
          <div className={scrollText}>
            Curated Collections • Award-Wining Authors • Critical Analysis •
