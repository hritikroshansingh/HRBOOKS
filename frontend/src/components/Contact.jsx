...
const Contact = () => {
  ...
  // FUNCTION SUBMIT DATA AND REDIRECT US TO WHATSAPP WEB WITH THAT DATA
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!validateForm()) return;

    const whatsappNumber = "7643099297";
            ...
            <div className=" space-y-6">
              <div className={styles.contactItemStyle}>
                ...
                <div>
                  ...
                  <p className=" text-gray-600">
                    221 Literary Lane, BookVilla, Patna 800023
                  </p>
                </div>
              </div>
              ...
              <div className={styles.contactItemStyle}>
                ...
                <div>
                  ...
                  <p className=" text-gray-600">contact@hrbooks.com</p>
                </div>
              </div>
              ...
              <div className={styles.contactItemStyle}>
                ...
                <div>
                  ...
                  <p className=" text-gray-600">+91 7643099297</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className=" space-y-2" key={field}>
                    ...
                    <div className={styles.inputWrapperStyle}>
                      {field === "name" ? (
                        ...
                        <Mail className=" absolute left-5 top-3 h-5 w-5 text-gray-400" />
                      )}
