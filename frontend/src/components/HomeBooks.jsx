...
import { ArrowBigRight, Minus, Plus, ShoppingCart, Star } from "lucide-react";
        ...
        <div className={styles.card}>
              ...
              return (
                <div key={book.id} className={styles.bookCard}>
                  ...
                  <p className={styles.author}>
                    {book.author} best author this week
                  </p>
                  ...
                  {item ? (
                    <div className={styles.qtyBox}>
                      ...
                      <span className=" target-grey-700">{item.quantity}</span>
                      <button
          ...
          <div className={styles.viewBtnWrapper}>
            <Link to="/books" className={styles.viewBtn}>
              ...
              <ArrowBigRight className={styles.viewIcon} />
            </Link>
          </div>
        </div>
      </div>
