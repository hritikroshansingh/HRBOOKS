        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className={navbarStyles.logoContainer}>
            <div className="relative group">
              ...
              <div className="relatine flex items-center">
                <img src={logo} alt="Logo" className={navbarStyles.logoImage} />
                <div className="ml-2">
                  <h1 className={navbarStyles.logoText}>HRBOOKS</h1>
            ...
            <div className="flex, flex-col space-y-1">
              ...
              <div className={navbarStyles.mobileIconRow}>
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                >
                  <FaOpencart className=" h-5 w-5 text-grey-600 group-hover:text-amber-600" />
                  {totalQuantity > 0 && (
                ...
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                >
                  <User className=" h-5, w-5 text-grey-600 group-hover:text-emerald-600" />
                </Link>
              </div>
            </div>
          </div>
